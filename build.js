...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Step2 = __webpack_require__(160);
	
	var _Step3 = __webpack_require__(161);
	
	var _Step4 = __webpack_require__(162);
	
	var _result = __webpack_require__(163);
	
	var _getData = __webpack_require__(164);
	
	var _NumNavigation = __webpack_require__(230);
	
	var _PrevNext = __webpack_require__(231);
	...
	var App = _react2.default.createClass({
		...
		getData: function getData() {
			...
			(0, _getData.httpGet)("../../data/cities.json").then(function (response) {
				...
				_this.setState({ cityData: mutateData });
				console.log(mutateData);
			}, function (error) {
				return console.log('Rejected: ' + error);
			});
			// Берем данные стран	
			(0, _getData.httpGet)("../../data/countries.json").then(function (response) {
				_this.setState({ countryData: JSON.parse(response) });
		...
		displayCurrentStep: function displayCurrentStep() {
		...
		hideAllSteps: function hideAllSteps(steps) {
		...
		validateStep1: function validateStep1() {
			...
			// errors
			var emptyName = document.querySelector('.emptyName');
			var emptyMail = document.querySelector('.emptyMail');
			var nonMail = document.querySelector('.nonMail');
		...
		validateStep2: function validateStep2() {
			...
			// errors
			var errorCity = document.querySelector('.errorCity');
			var errorCountry = document.querySelector('.errorCountry');
		...
		validateStep3: function validateStep3() {
			...
			//inputs
			var fb_inp = document.querySelector('#fb-input');
			var vk_inp = document.querySelector('#vk-input');
			var tw_inp = document.querySelector('#tw-input');
			var ok_inp = document.querySelector('#ok-input');
			//pattern
			var r = /^\w{2,}\.+\w{2,3}\/\w{2,}$/i; //dsjsdds.com/dsdsdsds
			// errors
			var errorPattern = document.querySelector('.ShowPattern');
			...
			if (fb.checked == true && !r.test(fb_inp.value)) {
				...
				this.setState({ facebook: fb_inp.value,
		...
		validateStep4: function validateStep4() {
			...
			// errors
			var noOneChosen = document.querySelector('#noOne');
			var dogChosen = document.querySelector('#doggy');
		...
		reRenderStep1: function reRenderStep1() {
			var counter = this.state.Step1ResetTimes + 1;
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'app' },
				_react2.default.createElement(_NumNavigation.NumNavigation, { onValidCheck1: this.validateStep1,
				...
				_react2.default.createElement(_Step.Step1, { key: this.state.Step1ResetTimes, isReset: this.state.Step1ResetTimes }),
				_react2.default.createElement(_Step2.Step2, { cities: this.state.cityData,
					countries: this.state.countryData
				}),
				_react2.default.createElement(_Step3.Step3, null),
				_react2.default.createElement(_Step4.Step4, null),
				_react2.default.createElement(_PrevNext.PrevNext, { onReRender: this.reRenderStep1,
					...
					currentStep: this.state.currentStep,
					onChangeStep: this.changeStep }),
				_react2.default.createElement(_result.Result, { name: this.state.name,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Step1 = exports.Step1 = _react2.default.createClass({
	  displayName: "Step1",
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "er nameErrors emptyName" },
	          " - Поле не должно оставаться пустым"
	        ),
	        _react2.default.createElement("br", null),
	        _react2.default.createElement("input", { id: "mail",
	          ref: "mail",
	          type: "email",
	          maxLength: "20",
	          placeholder: "E-mail",
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "er mailErrors emptyMail" },
	          "- Поле не должно оставаться пустым"
	        ),
	        _react2.default.createElement(
	          "div",
	          { className: "er mailErrors nonMail" },
	          "- Используйте следующий формат: example@example.expl"
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Step2 = exports.Step2 = _react2.default.createClass({
		displayName: "Step2",
		...
		renderCities: function renderCities(index, country) {
			...
			for (var i = 0; i < cities.length; i++) {
				...
				if (cities[i] === index && cities[i + 1] != cities[i - 1] && cities[i + 1] != country) {
					CityComponents.push(_react2.default.createElement(
						"option",
						{ key: i, value: cities[i + 1] },
						cities[i + 1]
					));
				}
			};
		...
		countrySelected: function countrySelected(event) {
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "er errorCity" },
						"- Вы должны выбрать город"
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Step3 = exports.Step3 = _react2.default.createClass({
		displayName: 'Step3',
	
		toggleInput: function toggleInput(e) {
			switch (e.target.id) {
				case "fb":
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'label',
							null,
							_react2.default.createElement('input', { id: 'fb', type: 'checkbox', value: 'Facebook', onChange: this.toggleInput }),
							'Facebook'
						),
						_react2.default.createElement('input', { maxLength: '24', id: 'fb-input', type: 'text', name: 'name', placeholder: 'Ваша страница в Facebook' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(
							'label',
							null,
							_react2.default.createElement('input', { id: 'vk', type: 'checkbox', value: 'Вконтакте', onChange: this.toggleInput }),
							'Вконтакте'
						),
						_react2.default.createElement('input', { maxLength: '24', id: 'vk-input', type: 'text', name: 'name', placeholder: 'Ваша страница Вконтакте' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(
							'label',
							null,
							_react2.default.createElement('input', { id: 'tw', type: 'checkbox', value: 'Twitter', onChange: this.toggleInput }),
							'Twitter'
						),
						_react2.default.createElement('input', { maxLength: '24', id: 'tw-input', type: 'text', name: 'name', placeholder: 'Ваша страница в Twitter' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(
							'label',
							null,
							_react2.default.createElement('input', { id: 'ok', type: 'checkbox', value: 'Одноклассники', onChange: this.toggleInput }),
							'Одноклассники'
						),
						_react2.default.createElement('input', { maxLength: '24', id: 'ok-input', type: 'text', name: 'name', placeholder: 'Ваша страница в Одноклассники' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'er ShowPattern' },
						'Формат: example.com/name'
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Step4 = exports.Step4 = _react2.default.createClass({
		displayName: 'Step4',
	
	
		iChooseYou: function iChooseYou(e) {
			var animals = document.querySelectorAll('.animals');
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('div', { id: 'cat1', className: 'animals', onClick: this.iChooseYou }),
					_react2.default.createElement('div', { id: 'cat2', className: 'animals', onClick: this.iChooseYou }),
					_react2.default.createElement('div', { id: 'cat3', className: 'animals', onClick: this.iChooseYou }),
					_react2.default.createElement('div', { id: 'dog4', className: 'animals', onClick: this.iChooseYou }),
					_react2.default.createElement(
						'p',
						{ id: 'noOne' },
						'Не может быть! Хоть один котик должен понравиться.'
					),
					_react2.default.createElement(
						'p',
						{ id: 'doggy' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Result = exports.Result = _react2.default.createClass({
		displayName: "Result",
	
	
		createSocialSpans: function createSocialSpans() {
			var array = [];
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"div",
					{ className: "card" },
					_react2.default.createElement("div", { className: "img", id: this.props.favoriteCat }),
					_react2.default.createElement(
						"h1",
						null,
						this.props.name
				...
				_react2.default.createElement("input", { type: "button", value: "Пройти заново", onClick: this.resetAll })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(176).Promise;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(175)
	  , hide          = __webpack_require__(179)
	  , Iterators     = __webpack_require__(191)
	  , TO_STRING_TAG = __webpack_require__(209)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var USE_NATIVE = !!function(){
	  try {
	    ...
	    var promise     = $Promise.resolve(1)
	      , FakePromise = (promise.constructor = {})[__webpack_require__(209)('species')] = function(exec){ exec(empty, empty); };
	...
	__webpack_require__(208)($Promise, PROMISE);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.NumNavigation = undefined;
	...
	var NumNavigation = exports.NumNavigation = _react2.default.createClass({
	  displayName: 'NumNavigation',
	  ...
	  resetAllActiveButtons: function resetAllActiveButtons() {
	    for (var key in this.refs) {
	      this.refs[key].classList.remove('complete-color');
	    };
	
	    for (var _key in this.refs) {
	      this.refs[_key].classList.remove('active-color');
	    };
	  },
	
	  sendInfoUp: function sendInfoUp(e) {
	    ...
	    switch (val) {
	      ...
	      case 3:
	        ...
	        break;
	      case 4:
	        if (this.props.onValidCheck1() == true && this.props.onValidCheck2() == true && this.props.onValidCheck3() == true) {
	          this.props.onChangeStep(val);
	        }
	      default:
	        break;
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'NumNavigation' },
	      _react2.default.createElement('input', { type: 'button', value: '1', ref: 'one', onClick: this.sendInfoUp }),
	      _react2.default.createElement('input', { type: 'button', value: '2', ref: 'two', onClick: this.sendInfoUp }),
	      _react2.default.createElement('input', { type: 'button', value: '3', ref: 'three', onClick: this.sendInfoUp }),
	      _react2.default.createElement('input', { type: 'button', value: '4', ref: 'four', onClick: this.sendInfoUp })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PrevNext = exports.PrevNext = _react2.default.createClass({
		displayName: 'PrevNext',
	
		decrement: function decrement() {
			var val = this.props.currentStep;
			if (val > 1) {
				val--;
				this.props.onChangeStep(val);
			}
		...
		checkLastAndResult: function checkLastAndResult() {
			var val = this.props.currentStep;
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'PrevNext' },
				_react2.default.createElement('input', { ref: 'previous', type: 'button', value: '<   Предыдущий', onClick: this.decrement }),
				_react2.default.createElement('input', { ref: 'next', type: 'button', value: 'Следующий   >', onClick: this.increment }),
				_react2.default.createElement('input', { ref: 'end', type: 'button', value: 'Завершить', onClick: this.checkLastAndResult })
			);
		}
	});
